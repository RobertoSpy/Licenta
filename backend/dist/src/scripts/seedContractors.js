            ...
            create: {
                ...
                contractor: {
                    create: {
                        ...
                        county: 'Ilfov',
                        coverageRadius: 50,
                        specializations: [client_1.ContractorSpecialization.FINISAJE, client_1.ContractorSpecialization.INSTALATII_ELECTRICE, client_1.ContractorSpecialization.INSTALATII_SANITARE],
            ...
            create: {
                ...
                contractor: {
                    create: {
                        ...
                        county: 'București',
                        coverageRadius: 200,
                        specializations: [client_1.ContractorSpecialization.CONSTRUCTII_GENERALE, client_1.ContractorSpecialization.STRUCTURA, client_1.ContractorSpecialization.FINISAJE, client_1.ContractorSpecialization.INSTALATII_ELECTRICE, client_1.ContractorSpecialization.INSTALATII_SANITARE],
