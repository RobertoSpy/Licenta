      ...
      <div>
        ...
        <div class="cover-meta">
          <div class="cover-meta-row">
            ...
            <span class="cover-meta-value">${(_a = project.locality) !== null && _a !== void 0 ? _a : '—'}, ${(_b = project.county) !== null && _b !== void 0 ? _b : '—'}</span>
          </div>
          <div class="cover-meta-row">
            <span class="cover-meta-label">🏠 Tip casă</span>
            <span class="cover-meta-value">${(_c = project.houseType) !== null && _c !== void 0 ? _c : '—'}</span>
          </div>
          <div class="cover-meta-row">
            <span class="cover-meta-label">📐 Regim înălțime</span>
            <span class="cover-meta-value">${project.floors !== null ? `P+${((_d = project.floors) !== null && _d !== void 0 ? _d : 1) - 1}` : '—'}</span>
          </div>
        </div>
  ...
  <div class="content-page">
    ...
    <div class="data-grid">
      ...
      <div class="data-box">
        ...
        <div class="data-value">${(_e = project.soilType) !== null && _e !== void 0 ? _e : 'Nespecificat'}</div>
      </div>
      <div class="data-box">
      ...
      <div class="data-box">
        ...
        <div class="data-value">${(_f = project.streetOrientation) !== null && _f !== void 0 ? _f : 'Nespecificat'}</div>
      </div>
    </div>
    ...
    <div class="chat-box">
      ...
      <div>${escapeHtml((_g = project.chatSummaries.find(s => s.phase === 'faza1')) === null || _g === void 0 ? void 0 : _g.summary).replace(/\\n/g, '<br/>')}</div>
    </div>` : ''}
  </div>
  ...
  <div class="content-page">
    ...
    <div class="data-grid">
      <div class="data-box">
        ...
        <div class="data-value">${(_h = project.houseType) !== null && _h !== void 0 ? _h : 'Standard'}</div>
      </div>
      <div class="data-box">
      ...
      <div class="data-box">
        ...
        <div class="data-value" style="text-transform: capitalize;">${(_j = project.budgetCategory) !== null && _j !== void 0 ? _j : 'Mediu'}</div>
      </div>
      <div class="data-box">
    ...
    <div class="chat-box" style="background: #eff6ff; border-color: #bfdbfe; border-left-color: #3b82f6; color: #1e40af;">
      ...
      <div>${escapeHtml((_k = project.chatSummaries.find(s => s.phase === 'faza2')) === null || _k === void 0 ? void 0 : _k.summary).replace(/\\n/g, '<br/>')}</div>
    </div>` : ''}
  </div>
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const rooms = rawRooms.map((room) => {
                ...
                return ({
                    ...
                    status: (_b = (_a = resultsById.get(room.id)) === null || _a === void 0 ? void 0 : _a.status) !== null && _b !== void 0 ? _b : 'ok',
                });
            });
            // 3. Build HTML
