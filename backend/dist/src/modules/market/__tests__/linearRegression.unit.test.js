...
describe('linearRegression Math Logic', () => {
    it('throws error when provided with < 2 points', () => {
        expect(() => (0, marketService_1.linearRegression)([])).toThrow('Nu există suficiente date');
        expect(() => (0, marketService_1.linearRegression)([100])).toThrow('Nu există suficiente date');
    });
    it('linearRegression with perfectly linear data has rmse=0', () => {
        // Values: 10, 20, 30, 40 (slope = 10, intercept = 10)
        const { slope, intercept, rmse } = (0, marketService_1.linearRegression)([10, 20, 30, 40]);
    ...
    it('linearRegression returns correct slope and intercept for known dataset', () => {
        ...
        const { slope, intercept, rmse } = (0, marketService_1.linearRegression)([5, 8, 9]);
    ...
    it('linearRegression with 2 points (minimum) returns valid result', () => {
        const { slope, intercept, rmse } = (0, marketService_1.linearRegression)([10, 15]);
    ...
    it('linearRegression with identical y values (flat line) has slope 0', () => {
        ...
        const { slope, intercept, rmse } = (0, marketService_1.linearRegression)([50, 50, 50]);
