...
exports.AGENT_SOURCES_BY_PURPOSE = exports.NORMATIVE_FILES = exports.NORMATIVE_REGISTRY = void 0;
// ─────────────────────────────────────────────────────────────────
// REGISTRY — configurație per normativ
// ─────────────────────────────────────────────────────────────────
exports.NORMATIVE_REGISTRY = {
    'P100-1-2013': {
...
const ACTIVE_SOURCES = Object.entries(exports.NORMATIVE_FILES)
    .filter(([, file]) => file !== '')
    .map(([source]) => source);
// Normative PER TIP CLĂDIRE
exports.AGENT_SOURCES_BY_PURPOSE = {
    residential: {
