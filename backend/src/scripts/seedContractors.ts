    ...
    create: {
      ...
      contractor: {
        create: {
          ...
          county: 'Ilfov',
          coverageRadius: 50,
          specializations: [ContractorSpecialization.FINISAJE, ContractorSpecialization.INSTALATII_ELECTRICE, ContractorSpecialization.INSTALATII_SANITARE],
    ...
    create: {
      ...
      contractor: {
        create: {
          ...
          county: 'București',
          coverageRadius: 200,
          specializations: [ContractorSpecialization.CONSTRUCTII_GENERALE, ContractorSpecialization.STRUCTURA, ContractorSpecialization.FINISAJE, ContractorSpecialization.INSTALATII_ELECTRICE, ContractorSpecialization.INSTALATII_SANITARE],
