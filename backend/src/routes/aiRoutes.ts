...
import { aiController, validateMaterialOverride } from '../controllers/aiController';
import { protect } from '../middleware/authMiddleware';
import { tenantGuard } from '../middleware/tenantGuard';
import { validateRequest, chatSchema, summarizeSchema, suggestRoomsSchema } from '../middleware/validateMiddleware';
...
router.post('/summary', protect, validateRequest(summarizeSchema), tenantGuard, aiController.saveSummary);
