...
export interface WeightedItem { id: string; weight: number; original: any }
export interface PlacedItem { id: string; bbox: BBoxM; original: any }
...
export function squarifyPartition(bbox: BBoxM, items: WeightedItem[], preserveOrder: boolean = false): PlacedItem[] {
